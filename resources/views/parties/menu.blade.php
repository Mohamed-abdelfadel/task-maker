<div class="d-flex flex-column flex-shrink-0 p-3 bg-body-tertiary h-100" style="width:100%;">
    ...
    <ul class="nav nav-pills flex-column mb-auto">
        <li class="nav-item ">
            <a href="{{ route('dashboard') }}"
               class="nav-link text-dark @if(request()->route()->getName() == 'dashboard') text-white text-bg-dark @endif"
               aria-current="page">
        ...
        <li>
            <div class="nav-link link-body-emphasis">
                <button class="btn btn-toggle d-inline-flex align-items-center rounded border-0 collapsed "
                        data-bs-toggle="collapse" data-bs-target="#tasks-collapse" aria-expanded="true">
                    Tasks
                </button>
    ...
    <div class="dropdown">
        <a href="#" class="d-flex align-items-center link-body-emphasis text-decoration-none dropdown-toggle"
           data-bs-toggle="dropdown" aria-expanded="false">
            <img src="{{asset('../storage/uploads/avatar/avatar.png')}}" alt="" width="32" height="32"
